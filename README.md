...
| 8 — Core CMS        | En cours                  | SQLite, API locale et authentification validés ; premier écran client du CMS implémenté et prêt à valider.                                         |
...
- Jalon 8 — en cours : contrat, SQLite, API locale et authentification validés ; [premier écran client du CMS à valider](docs/testing/cms-admin-validation.md).
