...
| 10 — Plugin SDK     | En cours                  | Catalogue généré utilisé par la Library, les types de sections et leurs slots par défaut.                                                          |
...
- Jalon 10 — en cours : catalogue automatique relié à la Library, aux types de sections et aux slots par défaut ; Inspector, générateur, CMS et commande de création restent à intégrer.
