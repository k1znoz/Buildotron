...
| 10 — Plugin SDK     | En cours                  | Catalogue utilisé par la Library, les types, les slots et les contenus initiaux des sections.                                                      |
...
- Jalon 10 — en cours : catalogue relié à la Library, aux types, aux slots et aux contenus initiaux ; Inspector, générateur, CMS et commande de création restent à intégrer.
