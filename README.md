...
| 10 — Plugin SDK     | En cours                  | Catalogue utilisé par la Library, le modèle et l'Inspector générique, y compris les assets Gallery.                                                |
...
- Jalon 10 — en cours : catalogue relié à la Library, au modèle et à tout l'Inspector ; les assets image sont déclarés dans le schéma Gallery.
