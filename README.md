...
| ------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 — Socle           | Correctif CI à valider    | Les deux premiers runs GitHub ont échoué au lint. Casse du chemin du workspace corrigée pour Linux ; nouveau run requis après push.                                                          |
...
| 5 — Sections        | En cours                  | Six plugins reliés au registre ; CTA, liste Features et refus des titres et textes vides validés dans le navigateur. Images de Gallery, questions de FAQ et formulaires CMS restent à créer. |
...
- Jalon 1 — correctif CI à valider : les deux runs GitHub ont échoué au lint ; la casse du workspace est corrigée, prochain run attendu après push.
...
- Jalon 5 — en cours : six plugins de Section intégrés ; CTA, liste Features et contrôle des champs vides validés dans le navigateur.
