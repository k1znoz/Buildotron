...
| 10 — Plugin SDK     | En cours                  | Catalogue utilisé par la Library, le modèle et l'Inspector générique, hors import de fichiers Gallery.                                             |
...
- Jalon 10 — en cours : catalogue relié à la Library, au modèle et aux listes structurées de l'Inspector ; Gallery reste spécialisée pour ses fichiers.
