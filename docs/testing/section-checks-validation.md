...
6. Effacer le titre d'une section. Le panneau doit reprendre l'erreur de validation du projet JSON. Renseigner de nouveau le titre : le contrôle doit revenir à son état précédent.
7. Vérifier que **Export React** reste désactivé.

Le contrôle se met à jour pendant l'édition après son ouverture. Il ne produit pas encore de projet exporté.
