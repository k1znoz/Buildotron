...
3. Extraire l'archive. Elle doit contenir douze fichiers, dont `package.json`, `README.md`, `eslint.config.js`, `src/content.json`, `src/App.tsx`, `src/sections.tsx` et `tests/content.test.mjs`.
